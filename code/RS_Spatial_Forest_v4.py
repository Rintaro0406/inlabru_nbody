...
def main():
    ...
    config = read_yaml_config("/Users/r.kanaki/code/inlabru_nbody/config/RS_Spatial_Forest_micecat1.yml")
    ...
    features_true = ["g_des_true", "r_des_true", "i_des_true", "z_des_true", "y_des_true"]
    features_realization = ["g_des_realization", "r_des_realization", "i_des_realization", "z_des_realization", "y_des_realization"]
    target_true = "z"
